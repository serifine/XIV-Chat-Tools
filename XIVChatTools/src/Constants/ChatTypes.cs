...
namespace XIVChatTools.Constants;

public static class ChatTypes
{
  public static readonly List<ChannelType> SupportedChannels = [
  ...
  public static bool IsSupportedChatType(XivChatType chatType)
  {
    return SupportedChannels.Any(c => c.ChatType == chatType);
  }
}